    ...
    public static class UserParser
    {
        ...
        public static ADUser IntraUserObjectToADObject(this IntraUser user)
        {
            return new ADUser
            {
                ...
                UserPrincipalName = $"{user.UserData.FirstName.ToLowerInvariant()}.{user.UserData.LastName.ToLowerInvariant().Replace(" ", ".")}@flowupdesiderius.onmicrosoft.com",
                Mail = $"{user.UserData.FirstName.ToLowerInvariant()}.{user.UserData.LastName.ToLowerInvariant().Replace(" ", ".")}@flowupdesiderius.onmicrosoft.com",
